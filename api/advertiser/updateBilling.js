module.exports = async (req, res, ctx) => {
  try {
    ...
    if (!advertiser.billingInfo || !advertiser.billingInfo.customerId) {
      ...
      await ctx.db.updateAdvertiserCustomerId(req.session.advertiserId, stripeCustomer.id)
    ...
    await ctx.db.updateAdvertiserHasCardInfo(req.session.advertiserId, last4)
