...
async function routes (fastify, opts, next) {
  ...
  fastify.post('/user/donation/create', { preHandler: (req, res, done) => userWebMiddleware(req, res, fastify, done), schema: Schema.user.createDonation }, (req, res) => createUserDonation(req, res, fastify))
